...
public class DAOUsuario extends DAOGenerico<Usuario> {
    ...
    public List<Usuario> listByNome(String senha) {
        return em.createQuery("SELECT e FROM Usuario e WHERE e.senha LIKE :senha").setParameter("senha", "%" + senha + "%").getResultList();
    }
    ...
    public List<Usuario> listInOrderNome() {
        return em.createQuery("SELECT e FROM Usuario e ORDER BY e.senha").getResultList();
    }
